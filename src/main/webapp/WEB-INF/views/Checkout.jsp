                        ...
                        <div class="header-cart-icon dropdown">
                            ...
                            <ul class="dropdown-menu cart-item-list">
                                ...
                                <li class="cart-item cart-total">
                                    <div class="alt-font margin-15px-bottom"><span class="w-50 d-inline-block  text-uppercase">Subtotal:</span><span class="w-50 d-inline-block text-right  font-weight-500">$199.99</span></div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12" id="accordion1">
                        ...
                        <div class="d-sm-flex justify-content-center align-items-center padding-10px-bottom text-center">
                            ...
                            <span class="text-extra-dark-gray alt-font">Returning customer?&nbsp;</span><a class="accordion-toggle text-extra-dark-gray text-decoration-underline" data-toggle="collapse" data-parent="#accordion1" href="#collapseOne"><span class="alt-font">Click here to login</span></a>
                        </div>
                        <div id="collapseOne" class="collapse text-center" data-parent="#accordion1">
                            <div class="w-40 mx-auto margin-4-half-rem-tb text-left lg-w-50 sm-w-100">
                                ...
                                <p class="text-right"><a href="#" class="btn btn-link  btn-medium text-extra-dark-gray margin-20px-bottom">Lost your password?</a></p>
                            </div>
                        </div>
                    </div>
                    <!-- end tab content -->
                    <div class="col-md-12">
                        ...
                        <div class="bg-transparent">
                            <div class="d-sm-flex justify-content-center align-items-center text-center">
                                ...
                                <span class="text-extra-dark-gray alt-font">Have a coupon?&nbsp;</span><a class="accordion-toggle text-extra-dark-gray text-decoration-underline" data-toggle="collapse" data-parent="#accordion1" href="#collapseTwo"><span class="alt-font">Click here to enter your code</span></a>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 checkout-accordion">
                                    <p class="title mb-2 d-flex">
                                        <label>
                                            <input class="d-inline w-auto mb-0 mr-2 mt-1" type="checkbox" name="account">
                                            <span class=" d-inline-block text-decoration-none">Create an account?</span> 
                                            <a class="accordion-toggle text-black" data-toggle="collapse" data-parent="#accordion1" href="#collapseThree"></a>
                                        </label>
                                    </p>
                                ...
                                <tbody>
                                    ...
                                    <tr class="total-amount">
                                        ...
                                        <td>
                                            ...
                                            <span class="text-small">(Includes $19.29 tax)</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <div class="w-100" id="accordion-style-05">
                                    ...
                                    <div class="heading active-accordion">
                                        <label>
                                            ...
                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-style-05" href="#style-5-collapse-1"></a>
                                        </label>
                                    </div>
                                    <div id="style-5-collapse-1" class="collapse show" data-parent="#accordion-style-05">
                                    ...
                                    <div class="heading active-accordion">
                                        <label>
                                            ...
                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-style-05" href="#style-5-collapse-2"></a>
                                        </label>
                                    </div>
                                    <div id="style-5-collapse-2" class="collapse collapse" data-parent="#accordion-style-05">
                                    ...
                                    <div class="heading active-accordion">
                                        <label>
                                            <input class="d-inline w-auto margin-10px-right mb-0" type="radio" name="payment-option">
                                            <span class="d-inline-block">PayPal <img src="https://placehold.it/319x110" alt="" class="w-120px margin-10px-left" ></span>
                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-style-05" href="#style-5-collapse-4"></a>
                                        </label>
                                    </div>
                                    <div id="style-5-collapse-4" class="collapse collapse" data-parent="#accordion-style-05">
